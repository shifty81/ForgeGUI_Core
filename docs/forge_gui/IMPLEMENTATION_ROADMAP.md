> **Current direction:** ForgeGUI is a universal modular desktop GUI core. Generic application
> surfaces, dock/tab stacks, movable toolbars, menus, status chrome and settings are the default.
> Canvas/viewport chrome is an optional authoring profile and must not define the framework shell.
...
## FG-C76–C82 — Canvas authoring profile + widget core (historical foundation)
