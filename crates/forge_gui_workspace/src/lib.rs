//! Canvas-first creator workspace widgets backed by ForgeRender surfaces.
//!
...
pub fn show_renderer_workspace(
    ...
    ui.painter()
        .rect_filled(outer_rect, 0.0, color(theme.chrome.canvas));
...
fn show_layer_stack(
    ...
    ui.painter()
        .rect_filled(stack, 4.0, color(theme.base.panel));
    ui.painter().rect_stroke(
        stack,
        4.0,
        Stroke::new(1.0, color(theme.chrome.separator)),
